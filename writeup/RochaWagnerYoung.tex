...
\begin{table}
\caption{Summary of studies of energy extraction from balanced flow
          by near-inertial waves with oceanographic applications.}
  \begin{center}
     \begin{tabular}{ p{.3\textwidth} p{.325\textwidth} p{.325\textwidth}   }
       \hline
         Study &  Framework &  Terminology \\ \hline
     \cite{gertz_straub2009} & {2D double-gyre solutions coupled with forced 3D
                              near-inertial perturbations.}
                              & {2D--to--3D energy transfer;
                                Reynolds stresses.}\\\hline
    \cite{whitt_thomas2015}  & Mixed-layer slab model modified by geostrophic
                              relative vorticity.
                            & Energy extraction; geostrophic shear production.\\\hline
     \cite{taylor_straub2016} & Channel-flow Boussinesq solutions with high- and
                                  low-frequency forcing.&
                                  Advective sink; Reynolds stresses.\\\hline
     \cite{barkan_etal2016} & Channel-flow Boussinesq solutions with high- and
                                  low-frequency forcing.
                              & Direct extraction; Reynolds stresses.\\\hline
     \cite{jing_etal2017}  & Mixed-layer slab model modified by geostrophic
                              relative vorticity and lateral strain.
                          & Energy transfer from mesoscale eddies to near-inertial
                            oscillations.\\\hline
    \cite{shakespeare_hogg2017} & Channel-flow Boussinesq solutions with
                                  low-frequency forcing.
                                & Interior amplification of internal waves generated
                                  near the surface;
                                  mean-to-wave energy transfer.
