...
%\shorttitle{Near-inertial waves extract energy from barotropic quasi-geostrophic flow}

\shortauthor{Cesar B. Rocha, Gregory L. Wagner, and William R Young}

\title{Extraction of Energy from Quasi-geostrohic Flow by Near-inertial Waves:
...
en route to viscous dissipation must, therefore, include higher-order, ageostrophic dynamics
\citep[e.g.,][]{mcwilliams2016}.
...
The emphasis on interactions of geostrophic flow with \textit{existing} internal waves---
...
The main analytical result of this paper, an equation for the wave potential
energy \eqref{Pw}, clarifies the physics of quasi-inviscid stimulated imbalance
associated with vertical vorticity and lateral strain. Numerical solutions of
...
To study the energy exchanges between near-inertial waves and quasi-geostrophic flow
