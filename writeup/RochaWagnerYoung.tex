...
\title{Stimulated imbalance: the energy transfer from quasi-geostrophic flow to
...
en route to viscous dissipation, therefore, must include ageostrophic flows
...
The emphasis on the energy extraction by \textit{existing} internal waves---
