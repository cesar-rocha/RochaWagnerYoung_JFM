...
\begin{figure}
\centering
\includegraphics[width=.9\textwidth]{figs/fig1.png}
\caption{Statistics for Lamb-Chaplygin dipole solution with $\hslash \approx 1$
        and $\alpha \approx 3.75$. Colors represent wave kinetic energy density,
         $|\phi'|^2/U_w^2$.
        Lines represent potential vorticity contours, $q\times U_e k_e = [
...
\caption{Statistics for Lamb-Chaplygin dipole solution with $\hslash \approx 1$
        ...
        Only the central $\tfrac{1}{5}\times\tfrac{1}{5}$ reguib of the domain
        is shown.}
\end{figure}
