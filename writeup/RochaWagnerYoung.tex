...
dispersion relation
\beq
\tfrac{\omg}{f_0} = \half \lambda^2|\kb|^2\left[1+\half\tfrac{\Phi^2}{f_0^2\lambda^2}
\right]^{1/2}\com
\eeq
...
\eeq
The frequency shift is positive definite and depends on the initial kinetic
energy of inertial oscillation $\Phi^2$. If the wave kinetic energy is small,
then the frequency shift is  $\approx  \Phi^2/(4 f_0^2\lambda^2)$.
