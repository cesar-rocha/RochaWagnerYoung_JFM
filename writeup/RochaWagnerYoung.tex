...
Geostrophic turbulence, a main paradigm of oceanic mesoscales,
...
transparently reveals the physics of quasi-inviscid stimulated imbalance associated
...
of potential enstrophy and wave kinetic and potential energies in numerical simulations.
...
\eeq
Also in \eqref{action}, $\varepsilon_\phi$ is the dissipation of wave kinetic energy
...
wave dissipation and $\varepsilon_q$ is the dissipation of quasigeostrophic
...
square of the geostrophic rate of strain. Hence, geostrophic straining enhances existing gradients
...
also satisfies the potential energy equation \eqref{Pw}. But the standard Young
\& Ben Jelloul wave equation is uncoupled from the quasigeostrophic potential
vorticity equation, hence the potential energy gain is not matched by a
decrease in quasigeostrophic kinetic energy.  \cite{young_benjelloul1997} and
 subsequent studies overlooked the wave potential energy power integral,
\eqref{Pw}, or its generalization to baroclinic quasigeostrophic flow.
...
turbulence, we consider a simpler example in which the quasigeostrophic flow
...
As for the initial wave velocity, we consider a uniform (i.e.,
...
cause a small zonal drift of the dipole. To render these effects negligible, we
...
energy loss, weakens the anticyclone.  This asymmetry in wave concentration
...
\underbrace{\tfrac{\nu_w}{f_0}\left\la \tfrac{\ii}{2}\left[\sJ(\psi,\phi)\lap^2\phis-
\sJ(\psi,\phis)\lap^2\phi\right]\right\ra}_{\Xi_a}\per
\eeq
