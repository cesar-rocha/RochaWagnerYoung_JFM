...
\begin{frame}[t]
  \begin{columns}[t]												% the [t] option aligns the column's content at the top
    ...
    \begin{column}{0.5\paperwidth}
      ...
      \begin{alertblock}{The physics of stimulated imbalance}
                ...
                \begin{column}{0.575\textwidth}
                  \begin{figure}
                    \includegraphics[width=0.9\textwidth]{figs/Gamma_a.pdf}
                    \caption{An illustration of the advective conversion,
                              $\Gamma_a$.}
                  \end{figure}
                \end{column}
    ...
    \begin{column}{\sepwid}\end{column}			% empty spacer column
    \begin{column}{0.5\paperwidth}					  % create a three-column-wide column and then we will split it up later

      \begin{columns}	% split up that three-column-wide column
